...
def inference(args):
    ...
    model.load_state_dict(torch.load("weights/unet_dataset_0/unet_100.pth"))
    model.eval()
    output_dir = "{}/{}".format(args.output_dir, args.model)
    os.makedirs(output_dir, exist_ok=True)
    test_img_path = r"D:\Python\computer_vision\Unet_mouse_tracking\data\trial"
...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default=r"D:\Python\computer_vision\Unet_mouse_tracking\data\output")
